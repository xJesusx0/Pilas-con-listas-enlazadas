...
import static pilasconlistas.Main.*;
import static pilasconlistas.Metodos.*;
import static pilasconlistas.Nodo.*;


import static pilasconlistas.Estilos.*;
...
public class ListasEnlazadas {
    ...
    public static void iniciarLista(){
        ...
        if(existeLista()){
            mostrarError("La pila ya ha sido creada");
            return;
        } 
        ...
        avisoFin("pila creada correctamente");
    }
    ...
    public static void imprimirLista(){
        ...
        if(!existeLista()){
            mostrarError("La pila no existe");
            return;
        }
